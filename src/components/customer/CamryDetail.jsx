...
// Assets
const HERO_IMAGE = 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryHero.webp?alt=media&token=1ff34154-e31b-4d1f-84f3-dbc00ce2bdac';

const colorVariants = [
  { name: 'Black', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryBlack.png?alt=media&token=da3363ff-449f-43a8-9f84-80beeb269753' },
  { name: 'Metal Stream', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryMetalStream.png?alt=media&token=48d6892c-71a7-481b-858e-4893ce1e90af' },
  { name: 'White', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryWhite.webp?alt=media&token=367f7d03-95b5-46b3-95ab-a0d37b6db9fd' },
];

const exteriorImages = [
    { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryEx1.webp?alt=media&token=75686f49-8721-46b4-8d88-1e7cb61cc9db', title: 'Elegant Front View', description: 'Desain depan yang tegas dan mewah.' },
    { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryEx2.webp?alt=media&token=c4276414-6ec8-48e4-b6b0-0b88e8b7fe00', title: 'Dynamic Side Profile', description: 'Garis bodi yang aerodinamis dan modern.' },
    { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryEx3.webp?alt=media&token=4f452118-108e-4252-b69c-e23bb27d6782', title: 'Sophisticated Rear Design', description: 'Tampilan belakang yang premium dan berkelas.' },
];

const interiorImages = [
    { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryIn1.webp?alt=media&token=2c7982ec-21cf-4d11-a1cc-dffe1e42720f', title: 'Luxurious Dashboard', description: 'Dashboard modern dengan material berkualitas tinggi.' },
    { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryIn2.webp?alt=media&token=62b72f3c-a887-4010-910b-cefc986c6f54', title: 'Spacious Cabin', description: 'Kabin penumpang yang lapang dan nyaman.' },
    { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCamry%2FamryIn3.webp?alt=media&token=b1ce7f21-491b-48d0-b26c-e1011adaf598', title: 'Advanced Infotainment', description: 'Sistem hiburan canggih untuk menemani perjalanan.' },
];

const CAR_NAME = 'Camry';
const PAGE_TITLE = 'TOYOTA CAMRY 2025';
const PAGE_DESCRIPTION = 'Toyota Camry 2025 adalah adalah Sedan premium yang mewah, bertenaga, dan cocok untuk eksekutif. Hubungi sales Auto2000 untuk informasi lengkap dan promo menarik.';

export default function CamryDetail() {
  ...
  return (
    <div className="bg-white font-montserrat overflow-x-hidden swipe-container" {...(swipeHandlers || {})}>
      <SEOHead 
        ...
        url="https://auto2000wayhalim.com/camry"
      />
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start justify-center">
                    ...
                    <div className="w-full md:w-2/3 flex-grow flex flex-col items-center">
                        ...
                        <div className="mt-8 w-full max-w-2xl mx-auto9509">
