...
// --- ASSETS ---
const HERO_IMAGE = 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FcrossHero.jpg?alt=media&token=5c46ef9d-1b09-4658-af6c-d2930cf1d76b';

const colorVariants = [
  { name: 'Celestite Gray Metallic', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FCross-Grey.webp?alt=media&token=8b077dfa-a9d0-4377-9979-26a8ec146075' },
  { name: 'Attitude Black Mica', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2Fcross-black.png?alt=media&token=48b2adb4-a1f1-4d68-a2e1-8674f0c4546a' },
];

const exteriorImages = [
    { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FcrossEx1.webp?alt=media&token=7104035f-8278-419d-b455-f9ced57c58b4', title: 'Desain Gagah & Modern', description: 'Tampilan SUV yang tangguh untuk segala medan.' },
    { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FCrossEx2.webp?alt=media&token=bc0691ad-3ce3-4abe-a785-85c3ff8bebb8', title: 'Profil Samping Dinamis', description: 'Garis bodi yang tegas memberikan kesan sporty.' },
    { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FCrossEx3.webp?alt=media&token=a2cf59d6-325b-4b37-af0e-adfc77bb2949', title: 'Tampilan Belakang Elegan', description: 'Desain belakang yang modern dengan lampu LED.' },
];

const interiorImages = [
    { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FcrossIn1.jpg?alt=media&token=ff8b7890-69f9-409a-ab71-0e5818830291', title: 'Kabin Premium', description: 'Interior mewah dengan material berkualitas tinggi.' },
    { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FcrossIn2.jpg?alt=media&token=e063ceff-7b8b-4590-aa02-5904f82a0763', title: 'Dashboard Canggih', description: 'Pusat kontrol intuitif dengan teknologi terkini.' },
    { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FCorolla%20Cross%2FcrossIn3.webp?alt=media&token=dc9a192f-7a8a-453c-866b-c2ea92750dc1', title: 'Ruang Kaki Lega', description: 'Kenyamanan superior untuk penumpang belakang.' },
];

const CAR_NAME = 'Corolla Cross';
const PAGE_TITLE = 'TOYOTA COROLLA CROSS 2025';
const PAGE_DESCRIPTION = 'Toyota Corolla Cross 2025 adalah adalah SUV kompak yang menggabungkan kenyamanan sedan dengan kepraktisan SUV. Hubungi sales Auto2000 untuk informasi lengkap dan promo menarik.';

// --- END OF ASSETS ---

export default function CorollaCrossDetail() {
  ...
  return (
    <div className="bg-white font-montserrat overflow-x-hidden swipe-container" {...(swipeHandlers || {})}>
      <SEOHead 
        ...
        url="https://auto2000wayhalim.com/corolla-cross"
      />
