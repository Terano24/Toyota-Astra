...
// --- ASSETS ---
const HERO_IMAGE = 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDainHero.jpg?alt=media&token=9dd947bb-e6ec-492e-814d-38a3b1717661';

const colorVariants = [
  { name: 'Red', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDainRED.png?alt=media&token=982b2a24-d68e-42ca-8c38-8b1e2fa4d415' },
];

const exteriorImages = [
    { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDainEks1.jpg?alt=media&token=b839a8a2-dcdb-47ff-bcb9-07d010f9bf2e', title: 'Desain Kabin Fungsional', description: 'Kabin lapang dengan visibilitas luas.' },
    { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDaineks2.jpg?alt=media&token=5cf4e00c-2b80-4b90-9844-9d37a2ed7673', title: 'Sasis Kuat dan Tangguh', description: 'Dibangun untuk menahan beban berat dan medan sulit.' },
    { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDaineks3.jpg?alt=media&token=407e57f7-bc68-45fb-8702-11a3d97ca000', title: 'Bak Kargo Luas', description: 'Kapasitas angkut besar untuk segala kebutuhan bisnis.' },
];

const interiorImages = [
    { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDainIn1.jpg?alt=media&token=edc6c84c-51fc-46f1-96e1-400e335317c6', title: 'Dasbor Ergonomis', description: 'Panel instrumen yang mudah dijangkau dan dibaca.' },
    { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDainin2.jpg?alt=media&token=b0acd326-88cc-421c-bc24-42c43cdbb592', title: 'Ruang Penyimpanan Praktis', description: 'Berbagai kompartemen untuk menunjang produktivitas.' },
    { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FDYNA%2FDainIn3.jpg?alt=media&token=c4d741c3-8f1a-499a-a0ab-2e7180602069', title: 'Posisi Mengemudi Nyaman', description: 'Kursi yang dirancang untuk mengurangi kelelahan.' },
];

const CAR_NAME = 'Dyna';
const PAGE_TITLE = 'TOYOTA DYNA 2025';
const PAGE_DESCRIPTION = 'Toyota Dyna 2025 adalah Truk ringan yang andal untuk kebutuhan bisnis dan logistik. Hubungi sales Auto2000 untuk informasi lengkap dan promo menarik.';

// --- END OF ASSETS ---

export default function DynaDetail() {
  ...
  return (
    <div className="bg-white font-montserrat overflow-x-hidden swipe-container" {...(swipeHandlers || {})}>
      <SEOHead 
        ...
        description="Toyota Dyna 2025 truk komersial handal di Auto2000 Way Halim Bandar Lampung. Kendaraan niaga dengan daya angkut besar dan efisiensi operasional tinggi."
        keywords="toyota dyna, dyna 2025, truk komersial, kendaraan niaga, auto2000 way halim, dealer toyota lampung"
        url="https://auto2000wayhalim.com/dyna"
      />
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start justify-center">
                    ...
                    <div className="w-full md:w-2/3 flex-grow flex flex-col items-center">
                        ...
                        <div className="mt-8 w-full max-w-2xl mx-auto8969">
