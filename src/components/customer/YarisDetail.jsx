...
// --- ASSETS ---
const HERO_IMAGE = 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisHero.jpg?alt=media&token=6ffe4e0d-27e6-4105-8cf7-b6660686f000';

const colorVariants = [
  { name: 'Platinum White', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisPlatinum%20White.png?alt=media&token=303fc7fa-328a-4fe8-be53-0da3db3de900' },
  { name: 'Precious Black', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisPreciousBlack.png?alt=media&token=85237c84-e5a7-4ad5-a422-7d2ed48fd3fb' },
  { name: 'Precious Metal', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisPreciousMetal.png?alt=media&token=a3a160ea-8f92-48d5-9bd8-1d22973bae25' },
  { name: 'Emotional Red', image: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisEmotional%20Red.png?alt=media&token=81c1d72b-d649-463d-a44a-99e9e49b7b79' },
];

const exteriorImages = [
  { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisEx1.jpg?alt=media&token=b69d9fe4-870a-4a72-b600-058bbcef8ab4', title: 'Desain Eksterior Modern', description: 'Garis bodi yang tajam dan aerodinamis memberikan kesan sporty.' },
  { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisEx2.jpg?alt=media&token=36f1b3ef-fa1d-4657-ada1-11abb98ec9b9', title: 'Tampilan Depan Agresif', description: 'Grille depan yang lebar dan lampu LED tajam menciptakan wajah yang garang.' },
  { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisEx3.jpg?alt=media&token=7458db0b-043a-4a38-b9da-520c132c1b40', title: 'Velg Alloy Sporty', description: 'Velg berdesain modern yang memperkuat karakter dinamis Yaris.' },
];

const interiorImages = [
  { id: 1, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisIn1.jpg?alt=media&token=5c2fbfa5-4d5a-47af-8ddf-7fee676c7473', title: 'Kabin Interior Premium', description: 'Interior lapang dengan material berkualitas tinggi untuk kenyamanan maksimal.' },
  { id: 2, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisIn2.jpg?alt=media&token=e4d9fa80-05ba-4955-ae4b-97557286af89', title: 'Dashboard Canggih', description: 'Pusat kontrol modern dengan layar sentuh dan fitur konektivitas lengkap.' },
  { id: 3, src: 'https://firebasestorage.googleapis.com/v0/b/astra-c196c.firebasestorage.app/o/SinglePage%2FYaris%2FRisIn3.jpg?alt=media&token=7677e661-014c-462d-95d6-212bc0c9f28f', title: 'Kenyamanan Kursi Penumpang', description: 'Kursi yang ergonomis memastikan kenyamanan penumpang di setiap perjalanan.' },
];

const CAR_NAME = 'Yaris';
const PAGE_TITLE = 'TOYOTA YARIS';
const PAGE_DESCRIPTION = 'Toyota Yaris adalah hatchback stylish yang nyaman untuk berkendara di dalam kota. Hubungi sales Auto2000 untuk informasi lengkap dan promo menarik.';

// --- END OF ASSETS ---

export default function YarisDetail() {
  ...
  return (
    <div className="bg-white font-montserrat overflow-x-hidden swipe-container" {...(swipeHandlers || {})}>
      <SEOHead 
        ...
        url="https://auto2000wayhalim.com/yaris"
      />
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start justify-center">
              ...
              <div className="w-full md:w-2/3 flex-grow flex flex-col items-center">
                ...
                <div className="mt-8 w-full max-w-2xl mx-auto9745">
